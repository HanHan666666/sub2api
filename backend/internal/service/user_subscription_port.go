...
type UserSubscriptionRepository interface {
	...
	IncrementRequestUsage(ctx context.Context, subscriptionID int64, count int64) error
	AdjustRequestUsage(ctx context.Context, subscriptionID int64, input *AdminAdjustRequestUsageInput) error
