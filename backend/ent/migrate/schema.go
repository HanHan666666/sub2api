...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "per_request_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "daily_limit_requests", Type: field.TypeInt64, Nullable: true},
		{Name: "weekly_limit_requests", Type: field.TypeInt64, Nullable: true},
		{Name: "monthly_limit_requests", Type: field.TypeInt64, Nullable: true},
	}
